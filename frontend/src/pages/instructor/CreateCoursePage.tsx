  ...
  const onSubmit = async (data: CourseForm) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Your course was sent to admin for approval.',
        variant: 'success',
      })
      ...
      setError(message)
      toast({ title: 'Course creation failed', description: message, variant: 'error' })
    } finally {
      setSubmitting(false)
    }
  }
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="title" {...form.register('title')} placeholder="Introduction to React" />
        ...
        {step === 2 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Submit for admin approval when ready</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              <div>
                ...
                <ul className="mt-2 space-y-1">
                  {reviewLessons.map((l, i) => (
                    <li key={i} className="text-sm">{i + 1}. {l.title}</li>
                  ))}
                </ul>
              </div>
            </CardContent>
